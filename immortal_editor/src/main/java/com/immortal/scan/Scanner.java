...
public final class Scanner
{
            ...
            throws IndexOutOfBoundsException
    {
        ...
        while (termPointer < termLen)
        {
            char c = advance();
            s += c;
            termPointer = c == terminator.charAt(termPointer) ? termPointer + 1 : 0;
        }
    ...
    public String advanceUntil(String terminator) throws IndexOutOfBoundsException
    { return advanceUntil(terminator, false); }

    public String advanceUntil(char terminator, boolean inclusive) throws IndexOutOfBoundsException
