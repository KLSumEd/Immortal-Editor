...
{
    public static <T> List<T> build(Class<? extends T> TTEnumClass)
    ...
    public static <T> List<T> buildFrom(
            Collection<Class<? extends T>> classCollection
    )
    {
    ...
    // public static <T extends Enum<T> & KnownLexTokenType>
    // List<KnownLexTokenType>
