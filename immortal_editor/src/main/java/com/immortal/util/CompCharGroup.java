...
public final class CompCharGroup implements CharGroup
{
    ...
    public CompCharGroup(
            Collection<CharRange> ranges, Collection<Character> chars
    )
    {
    ...
    @SafeVarargs public CompCharGroup(
            CharRangeList rangeList, Character... chars
    )
    {
        this.charSet = new CharSet(chars);
    ...
    @SafeVarargs public CompCharGroup(
            Collection<CharRange> ranges, Character... chars
    )
    {
        this.charSet = new CharSet(chars);
        this.charRanges = new CharRangeList(ranges);
    ...
    @SafeVarargs public CompCharGroup(
            Collection<Character> chars, CharRange... ranges
    )
    {
        this.charSet = new CharSet(chars);
        this.charRanges = new CharRangeList(ranges);
