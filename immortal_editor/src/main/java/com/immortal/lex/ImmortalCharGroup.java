...
{
    UPPER(_CharGroupRepo._upper), LOWER(_CharGroupRepo._lower),
    DIGIT(_CharGroupRepo._digit), ALPHA(_CharGroupRepo._alpha),
    ALPHA_NUM(_CharGroupRepo._alphaNum), ID_HEAD(_CharGroupRepo._idHead),
    ID_PART(_CharGroupRepo._idPart), VALID_SYMS(_CharGroupRepo._validSyms);
    ...
    private static final class _CharGroupRepo
    {
        ...
        public static final CharRangeList _alpha = new CharRangeList(_upper,
                _lower);
        public static final CharRangeList _alphaNum = new CharRangeList(_upper,
                _lower, _digit);
        public static final CompCharGroup _idHead = new CompCharGroup(_alpha,
                '_');
        public static final CompCharGroup _idPart = new CompCharGroup(_alphaNum,
                '_');
